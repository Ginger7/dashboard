jQuery.fn.flexdatalist = function (e, t) {
        ...
        this.init = function () {
            ...
            keypressValue: function (e, t) {
                ...
                if (r.length > 0 && a === t && !s.selectionRequired && s.multiple) {
                    r = l[0].value;
                    e.preventDefault(), e.stopPropagation(), i.fvalue.extract(r), i.results.remove()
                }
                ...
                if (t.removeOnBackspace && t.multiple) {
                    ...
                    8 === i.keyNum(e) && (0 === a.length ? r ? (i.fvalue.remove(r), l.data("_remove", null)) : l.data("_remove", l.parents("li:eq(0)").prev()) : l.data("_remove", null))
                }
            ...
            up: function () {
                l = this.getAlias(), i.options.get("multiple") ? o = this.multipleInput(l) : l.insertAfter(t), this.accessibility(l), t.attr("autofocus") && l.trigger("focus"), t.data("aliascontainer", o || l).addClass("flexdatalist flexdatalist-set").css({
                    position: "absolute",
                    top: -14e3,
                    left: -14e3
                }).attr("tabindex", -1);
                ...
                }).insertAfter(t).on("click", (function () {
                ...
                var i = {
                    ...
                    "aria-expanded": "false",
                    "aria-owns": (t.attr("id") ? t.attr("id") + "-flexdatalist" : n) + "-results"
                };
                e.attr(i)
            }
        }, this.fvalue = {
            get: function (e) {
                ...
                if (!i.fdisabled()) {
                    ...
                    var a = [];
                    if (i.isArray(e)) $.each(e, (function (e, t) {
                ...
                if (t = t || $.noop, 0 != s.length || 0 != n.length) {
                    if (e = this.toObj(e), !i.isEmpty(e) && !i.isEmpty(r) && "*" !== r) return i.isObject(r) || (r = r.split(",")), void i.data.load((function (a) {
                        i.isObject(e) ? i.isArray(e) || (e = [e]) : e = e.split(",");
                ...
                a || t.trigger("before:flexdatalist.value", [e, r]), i.isArray(e) ? $.each(e, (function (e, t) {
                    s.push(i.fvalue._extract(t))
                })) : s = i.fvalue._extract(e), a || t.data("result_selected", e).trigger("after:flexdatalist.value", [s, r]).trigger("change:flexdatalist", [s, r]).trigger("change")
            }, _extract: function (e) {
                ...
                add: function (e, t) {
                    var a = this;
                    this.li(e, t).on("click", (function () {
                        a.toggle($(this))
                    })).find(".fdl-remove").on("click", (function () {
                        i.fvalue.remove($(this).parent())
                    })), this.push(e), l[0].value = "", this.handleLimit()
                }, push: function (e, t) {
                    var a = i.fvalue.get();
                    ...
                    if (a.toggleSelected) {
                        var r = this.findLi(e);
                        if (r) {
                            var s = r.data(), n = r.hasClass("disabled") ? "enable" : "disable",
                                l = [{value: s.value, text: s.text, action: n}, a];
                            t.trigger("before:flexdatalist.toggle", l), "enable" === n ? r.removeClass("disabled") : r.addClass("disabled");
                            var u = [];
                            o.find("li.toggle:not(.disabled)").each((function () {
                                var e = $(this);
                                u.push(e.data("value"))
                            })), u = i.fvalue.toStr(u), i.value = u, t.trigger("after:flexdatalist.toggle", l).trigger("change:flexdatalist", l).trigger("change")
                        }
                    }
                }, remove: function (e) {
                    var t = this.findLi(e);
                    if (t) {
                        var a = i.fvalue.get(), r = t.index(), n = t.data(), l = {value: n.value, text: n.text};
                        return a.splice(r, 1), a = i.fvalue.toStr(a), i.value = a, t.remove(), i.fvalue.multiple.handleLimit(), s.splice(r, 1), this.handleLimit(), l
                    }
                }, removeAll: function () {
                    var e = i.fvalue.get(), a = i.options.get();
                    t.trigger("before:flexdatalist.remove.all", [e, a]), o.find("li:not(.input-container)").remove(), i.value = "", s = [], this.handleLimit(), t.trigger("after:flexdatalist.remove.all", [e, a])
                }, li: function (e, t) {
                    var a = o.find("li.input-container"), r = i.options.get();
                    return $("<li>").addClass("value" + (r.toggleSelected ? " toggle" : "")).append('<span class="text">' + t + "</span>").append('<span class="fdl-remove">&times;</span>').data({
                        text: t,
                        value: i.fvalue.toStr(e)
                    }).insertBefore(a)
                }, handleLimit: function () {
                    var e = this.isAtLimit(), t = o.find("li.input-container");
                    e ? t.hide() : t.show()
                }, isAtLimit: function () {
                ...
                if (i.isObject(e)) if (this.isJSON() || this.isMixed()) if (delete e.name_highlight, i.isArray(r)) {
                    for (var s = {}, n = 0; n < r.length; n++) {
                        var l = i.getPropertyValue(e, r[n]);
                        l && (s[r[n]] = l)
                    }
                    t = this.toStr(s)
                } else t = this.toStr(e); else t = i.isDefined(e, r) ? i.getPropertyValue(e, r) : i.isDefined(e, a.searchIn[0]) ? i.getPropertyValue(e, a.searchIn[0]) : null;
                return t
            }, text: function (e) {
                var t = e, a = i.options.get();
                return i.isObject(e) && (t = i.getPropertyValue(e, a.searchIn[0]), t = i.isDefined(e, a.textProperty) ? i.getPropertyValue(e, a.textProperty) : this.placeholders.replace(e, a.textProperty, t)), t = i.escapeHtml(t)
            }, placeholders: {
                replace: function (e, t, a) {
                    if (i.isObject(e) && "string" == typeof t) {
                        var r = this.parse(t);
                        if (!i.isEmpty(e) && r) return $.each(r, (function (a, r) {
                            i.isDefined(e, r) && (t = t.replace(a, i.getPropertyValue(e, r)))
                        })), t
                    }
                    return a
                }, parse: function (e) {
                ...
                return n.multiple && this.multiple.removeAll(), i.value = "", e && (l[0].value = ""), "" === r || a || t.trigger("change:flexdatalist", [{
                    value: "",
                    text: ""
                }, n]).trigger("clear:flexdatalist", [{value: "", text: ""}, n]).trigger("change"), s = [], this
            }, toObj: function (e) {
                if ("object" != typeof e) {
                    var t = i.options.get();
                    i.isEmpty(e) || !i.isDefined(e) ? e = t.multiple ? [] : this.isJSON() ? {} : "" : this.isCSV() ? e = (e = e.toString().split(t.valuesSeparator)).map((function (e) {
                        return e.trim()
            ...
            load: function (e, i) {
                ...
                var r = l.val(), s = i.options.get(), n = s.keywordParamName, o = s.searchContainParamName,
                    u = i.fvalue.get(), c = this.relativesData();
                if (i.isEmpty(s.url)) return e([]);
                var f = {};
                "post" === s.requestType && ($.each(s, (function (e, t) {
                    0 != e.indexOf("_") && "data" != e && (f[e] = t)
                })), delete f.relatives);
                var d = i.cache.keyGen({relative: c, load: a, keyword: r, contain: s.searchContain}, s.url),
                    h = i.cache.read(d, !0);
                if (h) e(h); else {
                    var p = "function" == typeof s.params ? s.params.call(t[0], r) : s.params,
                        g = $.extend(c, p, {load: a, selected: u, original: s.originalValue, options: f});
                    g[n] = r, g[o] = s.searchContain, this.remote({
                        url: s.url, data: g, success: function (t) {
                            l.val().length >= r.length && e(t), i.cache.write(d, t, s.cacheLifetime, !0)
                        }
                    })
                }
            }, remote: function (e) {
            ...
            get: function (e, a, r) {
                ...
                return t ? (e = e.replace(/[.*+?^${}()|[\]\\]/g, "\\$&"), t.replace(new RegExp(e, i.options.get("searchContain") ? "ig" : "i"), "|:|$&|::|")) : (e = e.split("|:|").join('<span class="highlight">')).split("|::|").join("</span>")
            }, find: function (e, t) {
                ...
                if ("string" == typeof e) {
                    ...
                    return "function" == typeof t && (e = t(e)), (e = e.normalize("NFD").replace(/[\u0300-\u036f]/g, "")).toUpperCase()
                }
                return e
            }
        }, this.results = {
            show: function (e) {
                ...
                if (!i.isEmpty(e)) {
                    var a = this.container(), r = l.val();
                    e = e.split("{keyword}").join(r), $("<li>").addClass("item no-results").append(e).appendTo(a), t.trigger("empty:flexdatalist.results", [e])
                }
            }, items: function (e, a) {
                var r = i.options.get("maxShownResults");
                t.trigger("show:flexdatalist.results", [e]);
                for (var s = 0; s < e.length && !(r > 0 && r === s); s++) this.item(e[s], s, e.length).appendTo(a);
                ...
                var s = $("<li>").attr({
                    ...
                    "aria-posinset": a + 1,
                    "aria-setsize": r
                }).data("item", e).addClass("item"), n = i.options.get(), l = n.visibleProperties;
                for (a = 0; a < l.length; a++) {
                    var o = l[a];
                    if (o.indexOf("{") > -1) {
                        var u = i.fvalue.placeholders.replace(e, o), c = i.fvalue.placeholders.parse(o);
                        f = $("<span>").addClass("item item-" + Object.values(c).join("-")).html(u + " ")
                    } else {
                        if (n.groupBy && n.groupBy === o || !i.isDefined(e, o)) continue;
                        var f = {};
                        if (o === n.iconProperty) f = $("<img>").addClass("item item-" + o).attr("src", e[o]); else {
                            var d = i.results.highlight(e, o);
                            f = $("<span>").addClass("item item-" + o).html(d + " ")
                        }
                    }
                    f.appendTo(s)
                }
                ...
                return 0 === a.length && (a = $("<ul>").addClass("flexdatalist-results ").appendTo("body").attr({
                    id: l.attr("id") + "-results",
                    role: "listbox"
                }).css({
            ...
            return !this.options.get("allowDuplicateValues") && (s.length > 0 && s.indexOf(this.fvalue.text(e)) > -1)
    ...
    e(document).data("flexdatalist") || e(document).on("mouseup", (function (t) {
        ...
        var i = e(".flexdatalist-results"), a = i.find("li"), r = a.filter(".active"), s = r.index(), n = a.length,
            l = t.which || t.keyCode;
        if (0 !== n) if (27 !== l) {
            if (13 === l) t.preventDefault(), r.trigger("click"); else if (40 === l || 38 === l) {
